...
function outputSingleImage($row) {
    echo "
        ...
        ."</div> <div class=\"button-box\">
                            <button onclick=\"alert('')\">Delate</button>
                        </div>
                    </div>
                </div>
...
<div class = "wrapper">
    <div class="sider flexbox-result">
        ...
        if($rowCount < 1) echo "<div style='text-align: center;'><br>You have no collection<br> Choose some and come back later :-)<br></div>";
        ?>
